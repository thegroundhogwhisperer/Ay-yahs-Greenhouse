...
# Uploads the latest SSTV image and N seconds old (or updated) Fldigi textout.txt file to Dropbox
def backup_textout_and_sstv_images_to_dropbox():
    ...
    dbx = dropbox.Dropbox('POPULATE_YOUR_ACCESS_TOKEN_VALUE_HERE')

    # Upload the Fldigi textout.txt file
    # Define the name and path to the textout.txt file
    fldigi_textout_txt_file_name_and_path = '/home/livestream/.fldigi/talk/textout.txt'
    ...
    last_fldigi_textout_seconds_since_unix_epoch_file_name = '/home/livestream/lasttextoutdropbox.txt'
...
#        print("\nThe current file modification time is different from the modification time of the last textout.txt file uploaded to a Dropbox account!\n\nWe now write the new modification time to a text file for later comparison.\n")
    ...
    list_of_sstv_image_files = glob.glob('/home/livestream/*.png') 
    ...
    last_image_name_list_file = '/home/livestream/lastimagedropbox.txt'
    # Open the file for reading
