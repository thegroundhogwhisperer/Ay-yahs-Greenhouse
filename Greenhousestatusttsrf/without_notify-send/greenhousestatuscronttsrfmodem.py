...
#
# requirements: wget, Ubuntu speech-dispatcher (spd-say), general-purpose software audio FSK modem (minimodem)
#
...
# */30 * * * * python3 /home/username/greenhousealarm/greenhousestatuscronttsrfmodem.py
...
def fetch_csv_file_read_last_environmental_record():
    ...
    audio_notification_text_to_speech(text_to_speech_message_content, rtty_modem_message_content)


# call the desktop notification program and the speech-dispatcher for text-to-speech
def audio_notification_text_to_speech(text_to_speech_message_content, rtty_modem_message_content):
