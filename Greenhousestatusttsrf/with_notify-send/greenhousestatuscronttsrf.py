...
#
# requirements: wget, Ubuntu speech-dispatcher (spd-say), Desktop notification application (notify-send)
#
...
# greenhousestatuscronttsrf.py also produces a notification bubble
