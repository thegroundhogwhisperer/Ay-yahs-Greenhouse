...
# Software speech synthesizer (eSpeakNG)
...
#
# Produces:  Greenhouse envrionmental data as text-to-speech audio, RTTY audio, and SSTV
#            audio as a single audio file played by play_audio.py via a modem connected
#            to a POTS (plain old telephone service) landline.
#  
#
